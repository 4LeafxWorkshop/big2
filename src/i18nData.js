export const I18N = {
  'zh-HK': {
    ...
    roomInviteShareText: '鋤大D差你一位高手，過嚟一齊開局救場。房間代碼：{{code}}。用呢條連結喺 web、Android 或 iPhone 打開：{{url}}',
    roomReady: '準備好',
    roomNotReady: '未準備',
    roomWaiting: '請等待',
    roomStart: '開局',
  ...
  en: {
    ...
    roomInviteShareText: 'Big Two has a seat waiting for you. Join the table and help clear the game. Room code: {{code}}. Open this link on web, Android, or iPhone: {{url}}',
    roomReady: 'Ready',
  ...
  fr: {
    ...
    roomInviteShareText: 'Big Two a une place pour vous. Rejoignez la table et aidez à terminer la partie. Code de salle : {{code}}. Ouvrez ce lien sur le web, Android ou iPhone : {{url}}',
    roomReady: 'Prêt',
  ...
  de: {
    ...
    roomInviteShareText: 'Big Two hat noch einen Platz frei. Komm an den Tisch und hilf beim Spielabschluss. Raumcode: {{code}}. Öffne diesen Link im Web, auf Android oder iPhone: {{url}}',
    roomReady: 'Bereit',
  ...
  es: {
    ...
    roomInviteShareText: 'Big Two tiene un lugar esperando por ti. Entra a la mesa y ayuda a cerrar la partida. Código de sala: {{code}}. Abre este enlace en web, Android o iPhone: {{url}}',
    roomReady: 'Listo',
  ...
  ja: {
    ...
    roomInviteShareText: 'Big Two に席がひとつ空いています。卓に参加して、ゲームを締めくくりましょう。ルームコード: {{code}}。このリンクを web、Android、iPhone で開いてください: {{url}}',
    roomReady: '準備完了',
    roomNotReady: '未準備',
    roomWaiting: '待機中',
    roomStart: '開始',
