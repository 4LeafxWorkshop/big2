export const I18N = {
  'zh-HK': {
    ...
    roomInviteShareText: '鋤大D差你一位高手，過嚟一齊開局救場。房間代碼：{{code}}。QR 碼／連結：{{url}}',
    roomReady: '準備好',
    roomNotReady: '未準備',
    roomWaiting: '請等待',
    roomStart: '開局',
  ...
  en: {
    ...
    roomInviteShareText: 'Big Two has a seat waiting for you. Join the table and help clear the game. Room code: {{code}}. QR code / link: {{url}}',
    roomReady: 'Ready',
  ...
  fr: {
    ...
    roomInviteShareText: 'Big Two a une place pour vous. Rejoignez la table et aidez à terminer la partie. Code de salle : {{code}}. QR / lien : {{url}}',
    roomReady: 'Prêt',
  ...
  de: {
    ...
    roomInviteShareText: 'Big Two hat noch einen Platz frei. Komm an den Tisch und hilf beim Spielabschluss. Raumcode: {{code}}. QR-Code / Link: {{url}}',
    roomReady: 'Bereit',
  ...
  es: {
    ...
    roomInviteShareText: 'Big Two tiene un lugar esperando por ti. Entra a la mesa y ayuda a cerrar la partida. Código de sala: {{code}}. QR / enlace: {{url}}',
    roomReady: 'Listo',
  ...
  ja: {
    ...
    roomInviteShareText: 'Big Two に席がひとつ空いています。卓に参加して、ゲームを締めくくりましょう。ルームコード: {{code}}。QRコード／リンク: {{url}}',
    roomReady: '準備完了',
    roomNotReady: '未準備',
    roomWaiting: '待機中',
    roomStart: '開始',
