export const I18N = {
  'zh-HK': {
    ...
    ruleItems: [
      ...
      '三張牌(三張牌要同一點數)',
      '五張牌組合',
      '蛇（Straight）：5張連續點數的牌，3-4-5-6-7最小，之後順序去到10-J-Q-K-A、J-Q-K-A-2、Q-K-A-2-3、K-A-2-3-4，A-2-3-4-5最大。若是數字相同的蛇，則比較蛇中最大點數那張的花色大小。',
  ...
  en: {
    ...
    ruleItems: [
      ...
      'Five-card hands',
      'Straight: five consecutive ranks. 3-4-5-6-7 is the lowest, then straights continue up to 10-J-Q-K-A, J-Q-K-A-2, Q-K-A-2-3, K-A-2-3-4, and A-2-3-4-5 is the highest. If two straights have the same ranks, compare the suit of the highest card.',
  ...
  ja: {
    ...
    ruleItems: [
      ...
      'トリプル（同じランク3枚）',
      '5枚役',
      'ストレート：5枚の連番。3-4-5-6-7 が最弱で、10-J-Q-K-A、J-Q-K-A-2、Q-K-A-2-3、K-A-2-3-4 と続き、A-2-3-4-5 が最強です。同じランクのストレートは最高位カードのスートで比較します。',
