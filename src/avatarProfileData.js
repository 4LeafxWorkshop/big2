export const AVATAR_BASE_SRC_BY_GENDER={
  male:'avatar-male.png',
  female:'avatar-female.png'
};

export const AVATAR_DICEBEAR_BASE='https://api.dicebear.com/9.x/avataaars/svg';

export const AVATAR_A4_COMMON={
...
export const AVATAR_A4_ENERGETIC={
...
export const AVATAR_A4_FACIAL_HAIR={
  list:['beardLight','beardMedium','moustacheFancy']
};

export const AVATAR_VARIANT_BY_NAME={
  '俊傑':'v2',
  '穎欣':'v2'
};

export const AVATAR_OVERRIDE_BY_NAME={
};
