...
export const BOT_PROFILES={zh:BOT_PROFILE_POOL,en:BOT_PROFILE_POOL};

export const OPPONENT_PROFILE_BY_NAME={
  '志明':{
    dob:'1992-05-18',
...
export const PROFILE_HOBBY_TRANSLATIONS={
  fr:{
...
export const PROFILE_ZODIAC_TRANSLATIONS={
  fr:{
    Taurus:'Taureau',
    Scorpio:'Scorpion',
    Pisces:'Poissons',
...
export function translateProfileHobby(value,langKey){
...
export function zodiacSymbol(name=''){
