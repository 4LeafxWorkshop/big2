      ...
      <div class="opponent-profile-body">
        <div class="opponent-profile-header">
          <div class="opponent-profile-avatar-wrap">
            <img class="opponent-profile-avatar" src="${avatarSrc}" alt="${esc(name)}" referrerpolicy="no-referrer" crossorigin="anonymous"/>
          </div>
