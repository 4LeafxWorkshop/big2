...
export function renderRoomActiveCardHtml(params){
  ...
  const joinInlineBtn=!isPrivate?`<button class="secondary room-card-join-btn room-card-join-inline room-icon-btn" data-code="${esc(room.code)}" ${joinDisabled?'disabled':''}><svg class="room-inline-icon" aria-hidden="true" viewBox="0 0 24 24"><path d="M10 6a4 4 0 1 1 0 8 4 4 0 0 1 0-8m0 10c4.418 0 8 1.79 8 4v1H2v-1c0-2.21 3.582-4 8-4m10-8h-2V6h-2v2h-2v2h2v2h2v-2h2z"/></svg><span>${t('roomJoin')}</span></button>`:'';
